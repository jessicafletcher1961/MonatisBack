...
public enum CompteTechniqueErreur implements MonatisErreur {
	...
	/**
			"Un problème technique est survenu lors de la vérification de l'absence d'opérations après la date de clôture %s du compte d'identifiant '%s'"),
	 */
	COMPTAGE_OPERATION_APRES_DATE_CLOTURE(
			"Un problème technique est survenu lors de la vérification de l'absence d'opérations après la date de clôture %s du compte d'identifiant '%s'"),
