...
public enum EvaluationTechniqueErreur implements MonatisErreur {
	 ...
	 */
	RECHERCHE_PAR_COMPTE_INTERNE_ID_DEPUIS_DATE_DEBUT(
			"Un problème technique est survenu lors de la recherche des évaluations du compte interne d'ID %s depuis le %s"),
	...
	/**
		"Un problème technique est survenu lors de la recherche de la dernière évaluation du compte interne d'identifiant '%s' entre le %s et le %s"), 
	 */
	RECHERCHE_DERNIERE_PAR_COMPTE_INTERNE_ENTRE_DATE_DEBUT_ET_DATE_FIN(
		"Un problème technique est survenu lors de la recherche de la dernière évaluation du compte interne d'identifiant '%s' entre le %s et le %s"), 
	;
