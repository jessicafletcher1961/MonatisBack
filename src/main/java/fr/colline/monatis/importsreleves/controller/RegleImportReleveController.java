...
import fr.colline.monatis.importsreleves.controller.request.RegleImportReleveApprentissageItemRequestDto;
import fr.colline.monatis.importsreleves.controller.request.RegleImportReleveApprentissageRequestDto;
import fr.colline.monatis.importsreleves.controller.request.RegleImportReleveSuggestionOperationRequestDto;
import fr.colline.monatis.importsreleves.controller.request.RegleImportReleveSuggestionRequestDto;
import fr.colline.monatis.importsreleves.controller.response.RegleImportReleveResponseDto;
import fr.colline.monatis.importsreleves.controller.response.RegleImportReleveSuggestionOperationResponseDto;
import fr.colline.monatis.importsreleves.controller.response.RegleImportReleveSuggestionResponseDto;
...
public class RegleImportReleveController {
	...
	private List<CritereSuggestion> mapperSuggestionRequestDto(RegleImportReleveSuggestionRequestDto dto) throws ControllerException {
		...
		for (RegleImportReleveSuggestionOperationRequestDto operationDto : dto.operations) {
			...
			critere.roleCompteContrepartie = verifierRoleCompteContrepartie(operationDto.roleCompteExterne);
			critere.compteInterneReleveId = operationDto.compteInterneContexteId;
			critere.identifiantCompteInterneReleve = operationDto.identifiantCompteInterneContexte;
	...
	private List<Apprentissage> mapperApprentissageRequestDto(RegleImportReleveApprentissageRequestDto dto) throws ControllerException, ServiceException {
		...
		for (RegleImportReleveApprentissageItemRequestDto itemDto : dto.operations) {
			...
			apprentissage.roleCompteContrepartie = verifierRoleCompteContrepartie(itemDto.roleCompteExterne);
			apprentissage.typeOperation = verifierTypeOperation(itemDto.codeTypeOperation);
			apprentissage.compteInterneReleveId = itemDto.compteInterneContexteId;
			apprentissage.identifiantCompteInterneReleve = itemDto.identifiantCompteInterneContexte;
			apprentissage.compteContrepartieId = itemDto.compteExterneId;
			apprentissage.identifiantCompteContrepartie = itemDto.identifiantCompteExterne;
	...
	private RoleCompteContrepartie verifierRoleCompteContrepartie(String roleCompteExterne) throws ControllerException {
		...
		RoleCompteContrepartie role = RoleCompteContrepartie.findByCode(roleCompteExterne);
		if (role == null) {
