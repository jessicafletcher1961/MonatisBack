...
public interface RegleImportReleveRepository extends JpaRepository<RegleImportReleve, Long> {
	...
	Optional<RegleImportReleve> findByCompteInterneReleveIdAndRoleCompteContrepartieAndCleLibelleNormalisee(
			Long compteInterneReleveId,
			RoleCompteContrepartie roleCompteContrepartie,
			String cleLibelleNormalisee);

	Optional<RegleImportReleve> findByCompteInterneReleveIsNullAndRoleCompteContrepartieAndCleLibelleNormalisee(
			RoleCompteContrepartie roleCompteContrepartie,
			String cleLibelleNormalisee);
}
