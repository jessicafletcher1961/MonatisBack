...
public class OperationPageRequestDto implements Serializable {
	...
	public LocalDate dateCreationApproximative;
	public LocalDate dateValeurDepuisLe;
	public LocalDate dateValeurJusqueAu;
	public String identifiantCompte1;
	public String identifiantCompte2;	
	public Boolean pointee;
	public Long montantEnCentimesPlancher;
	public Long montantEnCentimesPlafond;
	
	public List<String> nomsSousCategories;
	public List<String> nomsBeneficiaires;
	public List<String> codesTypeOperation;
	
	public Long compte1Id;
	public Long compte2Id;
	public List<Long> sousCategoriesIds;
	public List<Long> beneficiairesIds;
}
