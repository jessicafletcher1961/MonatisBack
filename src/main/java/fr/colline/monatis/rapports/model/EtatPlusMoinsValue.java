...
public class EtatPlusMoinsValue {
	...
	private PlusMoinsValuePeriode[] cumuls;
	...
	public List<PlusMoinsValueTypeFonctionnementLigne> getLignesTypeFonctionnement() {
		return lignesTypeFonctionnement;
	}

	public void setLignesTypeFonctionnement(List<PlusMoinsValueTypeFonctionnementLigne> lignesTypeFonctionnement) {
		this.lignesTypeFonctionnement = lignesTypeFonctionnement;
	}

	public PlusMoinsValuePeriode[] getCumuls() {
		return cumuls;
	}

	public void setCumuls(PlusMoinsValuePeriode[] cumuls) {
		this.cumuls = cumuls;
	}
