...
public class ReleveOperationCompte {
	...
	private Long montantEcartEnCentimes;
	...
	public Long getMontantEcartEnCentimes() {
		return montantEcartEnCentimes;
	}

	public void setMontantEcartEnCentimes(Long montantTotalEcartEnCentimes) {
		this.montantEcartEnCentimes = montantTotalEcartEnCentimes;
	}
}
