...
public enum TypeOperation {
	...
	TRANSFERT ("TRANSFERT", "Transfert", "Transfert des fonds entre deux comptes c (interne/COURANT)", false, false),
	...
	REMUNERATION_COMPTE_COURANT("COURANT+", "Rémunérations des comptes courants", "Prise en compte des recettes intrinsèques à un compte courant (interne/COURANT) comme la rémunération des comptes courants proposée par certaines banques", true, false),
