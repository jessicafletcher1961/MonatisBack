...
class OperationPaginationRepositoryTest {
	...
	void initialiser() {
		...
		persisterOperation("OP001", TypeOperation.DEPENSE, "CB AUX PAINS DES I FACT", LocalDate.of(2025, 1, 21), LocalDate.of(2025, 1, 4), 1240L, boulangerie, compteCourant, false);
		persisterOperation("OP002", TypeOperation.RECETTE, "SALAIRE", LocalDate.of(2025, 1, 21), LocalDate.of(2025, 1, 5), 220000L, compteCourant, employeur, true);
		persisterOperation("OP003", TypeOperation.DEPENSE, "CB AUX PAINS DES I FACT", LocalDate.of(2025, 1, 21), LocalDate.of(2025, 1, 6), 950L, boulangerie, compteCourant, false);
		entityManager.flush();
	}
	...
	void paginerOperationsRetourneTotalEtPageDemandee() {
		...
		Page<Operation> page = operationRepository.findAll(
				OperationFiltreConstructeur.filtrer(null, null, null, null, null, null, null, null, null),
	...
	void filtrerOperationsCombineRechercheTypeCompteEtPointee() {
		...
		Page<Operation> page = operationRepository.findAll(
				OperationFiltreConstructeur.filtrer(
						"depense",
